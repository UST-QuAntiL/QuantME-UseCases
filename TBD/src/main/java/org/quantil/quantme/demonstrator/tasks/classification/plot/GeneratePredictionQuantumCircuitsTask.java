...
public class GeneratePredictionQuantumCircuitsTask implements JavaDelegate {

    private final static Logger LOGGER = LoggerFactory.getLogger(GeneratePredictionQuantumCircuitsTask.class);

    @Override
    public void execute(DelegateExecution execution) throws Exception {
        LOGGER.info("Sending request to generate new circuits for the plot generation...");
        ...
        // theta plus and minus are not required for the plot generation
        request.setThetasPlusUrl("");
        request.setThetasMinusUrl("");
