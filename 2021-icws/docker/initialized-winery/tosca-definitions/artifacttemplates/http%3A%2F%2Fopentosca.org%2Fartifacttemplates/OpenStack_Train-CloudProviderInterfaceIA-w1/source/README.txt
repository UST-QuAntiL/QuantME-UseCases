###########################################################################
GENERATED IMPLEMENTATION ARTIFACT SKELETON FOR OpenStack Train CloudProviderInterface

Interface Name: org_opentosca_NodeTypes_OpenStack_Train_CloudProviderInterface
Namespace: http://NodeTypes.opentosca.org/
Java Package: org.opentosca.NodeTypes
URL: http://localhost:8080/winery/artifacttemplates/http%253A%252F%252Fopentosca.org%252FNodeTypes/OpenStack_Train-CloudProviderInterfaceIA-w1/files/
###########################################################################
