...
def get_oracle_from_url(oracle_url, oracle_id):
    ...
    oracle_file_name = "oracle_code_" + "_" + str(oracle_id)
...
def get_circuit_from_binary(circuit_id, circuit_base64):
    ...
    circuit = circuit_mod.get_circuit()
